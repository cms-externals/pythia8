...
<h2>Four-Vectors</h2> 
<ol id="toc">
  <li><a href="#section0">Constructors and basic operators</a></li>
  <li><a href="#section1">Member methods for input</a></li>
  <li><a href="#section2">Member methods for output</a></li>
  <li><a href="#section3">Friend methods for output</a></li>
  <li><a href="#section4">Operations with four-vectors</a></li>
  <li><a href="#section5">Rotations and boosts</a></li>
</ol>
...
<a name="anchor85"></a>
<p/><strong> RotBstMatrix& RotBstMatrix::operator*(const RotBstMatrix& Min) &nbsp;</strong> <br/>
return the combination of this and another matrix (corresponding to first 
making the transformation <i>M_{in}</i> and then this transformation. 
   
 
<a name="anchor86"></a>
<p/><strong> Vec4 RotBstMatrix::operator*(Vec4 p) const &nbsp;</strong> <br/>
return a rotated and boosted version of <i>p</i>. 
...
<a name="anchor88"></a>
<p/><strong> RotBstMatrix RotBstMatrix::inverse() const &nbsp;</strong> <br/>
...
<a name="anchor93"></a>
<p/><strong> RotBstMatrix toCMframe(const Vec4& p) &nbsp;</strong> <br/>
Return a <code>RotBstMatrix</code> corresponding to a boost 
to the rest frame of <i>p</i>. 
   
 
<a name="anchor94"></a>
<p/><strong> RotBstMatrix fromCMframe(const Vec4& p) &nbsp;</strong> <br/>
Return a <code>RotBstMatrix</code> corresponding to a boost 
from the rest frame of <i>p</i> . 
   
 
<a name="anchor95"></a>
<p/><strong> RotBstMatrix toCMframe(const Vec4& p1, const Vec4& p2) &nbsp;</strong> <br/>
Return a <code>RotBstMatrix</code> corresponding to a boost and 
rotation to the rest frame of <i>p_1</i> and <i>p_2</i>, with 
<i>p_1</i> along the <i>+z</i> axis. 
   
 
<a name="anchor96"></a>
<p/><strong> RotBstMatrix fromCMframe(const Vec4& p1, const Vec4& p2) &nbsp;</strong> <br/>
Return a <code>RotBstMatrix</code> corresponding to a boost and 
rotation from the rest frame of <i>p_1</i> and <i>p_2</i>, with 
<i>p_1</i> along the <i>+z</i> axis. 
   
 
<a name="anchor97"></a>
<p/><strong> RotBstMatrix toCMframe(const Vec4& ptot, const Vec4& pz, const Vec4& pxz) &nbsp;</strong> <br/>
Return a <code>RotBstMatrix</code> corresponding to a boost and 
rotation to the rest frame of <i>p_{tot}</i>, where additionally 
the <i>p_z</i> vector is put along the <i>+z</i> axis and the 
<i>p_{xz}</i> on put in the <i>xz</i> plane with positive <i>x</i>. 
   
 
<a name="anchor98"></a>
<p/><strong> RotBstMatrix fromCMframe(const Vec4& ptot, const Vec4& pz, const Vec4& pxz) &nbsp;</strong> <br/>
Return a <code>RotBstMatrix</code> corresponding to a boost and 
rotation from the rest frame of <i>p_{tot}</i>, where additionally 
the <i>p_z</i> vector is along the <i>+z</i> axis and the 
<i>p_{xz}</i> is in the <i>xz</i> plane with positive <i>x</i> 
