...
shower merging scheme, as presented in [<a href="Bibliography.php#refLon12" target="page">Lon12</a>]. Unitarised ME+PS 
...
samples [<a href="Bibliography.php#refLon12" target="page">Lon12</a>]. The main philosophy of UMEPS is "subtract what you 
...
program produces HepMC events [<a href="Bibliography.php#refDob01" target="page">Dob01</a>], that can be histogrammed (e.g. 
using RIVET [<a href="Bibliography.php#refBuc10" target="page">Buc10</a>]), or used as input for a detector simulation. If 
