...
<h2>User Hooks</h2> 
<ol id="toc">
  <li><a href="#section0">The basic components</a></li>
  <li><a href="#section1">(i) Interrupt between the main generation levels</a></li>
  <li><a href="#section2">(ii) Interrupt during the parton-level evolution, at a </a></li>
  <li><a href="#section3">(iii) Interrupt during the parton-level evolution, after a step</a></li>
  <li><a href="#section4">(iv) Veto emissions</a></li>
  <li><a href="#section5">(v) Modify cross-sections or phase space sampling</a></li>
  <li><a href="#section6">(vi) Reject the decay sequence of resonances</a></li>
  <li><a href="#section7">(vii) Modify scale in shower evolution</a></li>
  <li><a href="#section8">(viii) Allow colour reconnection</a></li>
  <li><a href="#section9">(ix) Enhanced rate of rare shower splittings</a></li>
  <li><a href="#section10">(x) Modified hadronization</a></li>
  <li><a href="#section11">Multiple user hooks</a></li>
</ol>
...
<br/><code>isr:G2QQ:cc</code> for <i>g &rarr; c + cbar</i> 
<br/><code>isr:G2QQ:bb</code> for <i>g &rarr; b + bbar</i> 
...
with <i>q</i> a light quark, 
<br/><code>fsr:G2QQ:cc</code> for <i>g &rarr; c + cbar</i> 
<br/><code>fsr:G2QQ:bb</code> for <i>g &rarr; b + bbar</i> 
...
<code>doVetoFragmentation(...)</code> and 
<code>setStringEnds(...)</code>. 
   
 
<a name="anchor48"></a>
<p/><strong> virtual bool doChangeFragPar(StringFlav* flavPtr, StringZ* zPtr, StringPT* pTPtr, int idEnd, double m2Had, vector&lt;int&gt; iParton, const StringEnd * sEnd) &nbsp;</strong> <br/>
...
<br/><code>argument</code><strong> sEnd </strong>  :  is a pointer to a <code>StringEnd</code> object 
 containing additional information about the string break. 
   
   
 
<a name="anchor49"></a>
<p/><strong> virtual bool doVetoFragmentation(Particle had, const StringEnd * sEnd) &nbsp;</strong> <br/>
...
<a name="anchor50"></a>
<p/><strong> virtual bool doVetoFragmentation(Particle had1, Particle had2, const StringEnd * sEnd1, const StringEnd * sEnd1) &nbsp;</strong> <br/>
This method can veto the production of the final hadrons produced in the 
fragmentation of a string. 
<br/><code>argument</code><strong> had1,had2 </strong>  :  are (copies of) the two final hadrons being 
produced, just before they are added to the event record. 
   
<br/><code>argument</code><strong> sEnd1,sEnd2 </strong>  :  are pointers to <code>StringEnd</code> objects 
containing additional information about the string break. 
   
   
 
<a name="anchor51"></a>
<p/><strong> virtual bool canSetImpactParameter() &nbsp;</strong> <br/>
In the base class this method returns false. If you redefine it to 
return true, it will enable the method <code>doSetImpactParameter()</code> . 
   
 
<a name="anchor52"></a>
<p/><strong> virtual bool doSetImpactParameter() &nbsp;</strong> <br/>
This method allows the user to select a particular impact parameter in the 
MPI machinery in the generation of minimum-bias events. The function takes no 
arguments and is intended for situations where the impact parameter is 
generated from the outside, as is the case in the Angantyr model for Heavy Ion 
collisions. Note that it does not modify the <?php $filepath = $_GET["filepath"];
echo "<a href='MultipartonInteractions.php?filepath=".$filepath."' target='page'>";?> 
  <code>MultipartonInteractions:bProfile</code></a> used in the MPI 
machinery, and that currently it will only affect the <?php $filepath = $_GET["filepath"];
echo "<a href='QCDProcesses.php?filepath=".$filepath."' target='page'>";?> 
  <code>SoftQCD</code></a> processes. 
