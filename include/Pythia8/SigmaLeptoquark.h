...
public:
  ...
  // Constructor.
  Sigma1ql2LeptoQuark() : idQuark(), idLepton(), mRes(), GammaRes(), m2Res(), GamMRat(), kCoup(), widthIn(), sigBW(), LQPtr() {}
...
public:
  ...
  // Constructor.
  Sigma2qg2LeptoQuarkl() : idQuark(), idLepton(), mRes(), GammaRes(), m2Res(), GamMRat(), kCoup(), openFracPos(), openFracNeg(), sigma0() {}
...
public:
  ...
  // Constructor.
  Sigma2gg2LQLQbar() : mRes(), GammaRes(), m2Res(), GamMRat(), openFrac(), sigma() {}
...
public:
  ...
  // Constructor.
  Sigma2qqbar2LQLQbar() : idQuark(), mRes(), GammaRes(), m2Res(), GamMRat(), kCoup(), openFrac(), sigmaDiff(), sigmaSame() {}
