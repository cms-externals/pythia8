...
public:
  ...
  Info() : LHEFversionSave(0), initrwgt(NULL), generators(NULL),
    ...
    weights(NULL), rwgt(NULL), eventWeightLHEF(), hiinfo(0), idASave(), idBSave(), pzASave(), eASave(), mASave(), pzBSave(), eBSave(), mBSave(), eCMSave(0.), sSave(),
    lowPTmin(false), nTry(), nSel(), nAcc(), sigGen(), sigErr(), wtAccSum(), lhaStrategySave(), a0MPISave(0.), isRes(), isDiffA(), isDiffB(), isDiffC(), isND(), isLH(), hasSubSave(), bIsSet(), evolIsSet(), atEOF(), isVal1(), isVal2(), hasHistorySave(),
