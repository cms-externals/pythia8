...
public:
  ...
  SpaceDipoleEnd( int systemIn = 0, int sideIn = 0, int iRadiatorIn = 0,
    ...
    nBranch(0), idDaughter(), idMother(), idSister(), iFinPol(), x1(), x2(), m2Dip(), pT2(), z(), xMo(), Q2(), mSister(), m2Sister(), pT2corr(), pT2Old(0.), zOld(0.5), asymPol(), m2IF(), mColPartner(), pAccept() { }
