...
public:
  ...
  // Constructor.
  StringFragmentation() : infoPtr(), particleDataPtr(), rndmPtr(), flavSelPtr(), pTSelPtr(), zSelPtr(), flavRopePtr(), userHooksPtr(), closePacking(), doFlavRope(), stopMass(), stopNewFlav(), stopSmear(), eNormJunction(), eBothLeftJunction(), eMaxLeftJunction(), eMinLeftJunction(), mJoin(), bLund(), pT20(), hasJunction(), isClosed(), iPos(), iNeg(), w2Rem(), stopMassNow() {}
