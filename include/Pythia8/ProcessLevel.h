...
public:
  ...
  // Constructor.
  ProcessLevel() : doSecondHard(), doSameCuts(), allHardSame(), noneHardSame(), someHardSame(), cutsAgree(), cutsOverlap(), doResDecays(), doISR(), doMPI(), nImpact(), startColTag(), mHatMin1(), mHatMax1(), pTHatMin1(), pTHatMax1(), mHatMin2(), mHatMax2(), pTHatMin2(), pTHatMax2(), sigmaND(), sumImpactFac(), sum2ImpactFac(), beamHasGamma(), gammaMode(), iContainer(), iLHACont(-1), sigmaMaxSum(), i2Container(), sigma2MaxSum(), infoPtr(), particleDataPtr(), rndmPtr(), beamAPtr(), beamBPtr(), beamGamAPtr(), beamGamBPtr(), couplingsPtr(), sigmaTotPtr(), slhaInterfacePtr(), userHooksPtr(), lhaUpPtr() {}
