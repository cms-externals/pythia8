...
public:
  ...
  // Constructor.
  HadronLevel() : doHadronize(), doDecay(), doBoseEinstein(), allowRH(), closePacking(), mStringMin(), eNormJunction(), widthSepBE(), doHadronScatter(), hsAfterDecay(), hadronScatMode(), infoPtr(), particleDataPtr(), rndmPtr(), userHooksPtr(), couplingsPtr(), rHadronsPtr(), useHiddenValley() {}
