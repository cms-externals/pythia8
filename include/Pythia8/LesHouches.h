...
protected:
  ...
  LHAup(int strategyIn = 3) : infoPtr(), nupSave(), idprupSave(), xwgtupSave(),
    ...
    scalePDFInSave(), pdf1InSave(), pdf2InSave(), fileName("void"), dateNow(),
    timeNow(), strategySave(strategyIn), idBeamASave(), idBeamBSave(),
    eBeamASave(), eBeamBSave(), pdfGroupBeamASave(), pdfGroupBeamBSave(),
    pdfSetBeamASave(), pdfSetBeamBSave(), idProc(), weightProc(), scaleProc(),
    alphaQEDProc(), alphaQCDProc(), pdfIsSetSave(), id1Save(), id2Save(),
    id1pdfSave(), id2pdfSave(), x1Save(), x2Save(), x1pdfSave(), x2pdfSave(),
