...
public:
  ...
  // Constructor.
  Sigma2ff2fftgmZ() : gmZmode(), mZ(), mZS(), thetaWRat(), sigmagmgm(), sigmagmZ(), sigmaZZ() {}
...
public:
  ...
  // Constructor.
  Sigma2qq2QqtW(int idIn, int codeIn) : idNew(idIn), codeSave(codeIn), mW(), mWS(), thetaWRat(), sigma0(), openFracPos(), openFracNeg() {}
...
public:
  ...
  // Constructor.
  Sigma1ffbar2gmZ() : gmZmode(), mRes(), GammaRes(), m2Res(), GamMRat(), thetaWRat(), gamSum(), intSum(), resSum(), gamProp(), intProp(), resProp(), particlePtr() {}
...
public:
  ...
  // Constructor.
  Sigma1ffbar2W() : mRes(), GammaRes(), m2Res(), GamMRat(), thetaWRat(), sigma0Pos(), sigma0Neg(), particlePtr() {}
...
public:
  ...
  // Constructor.
  Sigma2ffbar2ffbarsgmZ() : gmZmode(), mRes(), GammaRes(), m2Res(), GamMRat(), thetaWRat(), colQ(), gamSumT(), gamSumL(), intSumT(), intSumL(), intSumA(), resSumT(), resSumL(), resSumA(), gamProp(), intProp(), resProp(), cThe(), particlePtr() {}
...
public:
  ...
  // Constructor.
  Sigma2ffbar2ffbarsW() : id3New(), id4New(), mRes(), GammaRes(), m2Res(), GamMRat(), thetaWRat(), sigma0(), particlePtr() {}
...
public:
  ...
  Sigma2ffbar2FFbarsgmZ(int idIn, int codeIn) : idNew(idIn),
    codeSave(codeIn), gmZmode(), isPhysical(), ef(), vf(), af(), mRes(), GammaRes(), m2Res(), GamMRat(), thetaWRat(), mr(), betaf(), cosThe(), gamProp(), intProp(), resProp(), openFracPair() {}
...
public:
  ...
  Sigma2ffbar2FfbarsW(int idIn, int idIn2, int codeIn) : idNew(idIn),
    idNew2(idIn2), codeSave(codeIn), idPartner(), isPhysical(), V2New(), mRes(), GammaRes(), m2Res(), GamMRat(), thetaWRat(), sigma0(), openFracPos(), openFracNeg() {}
...
public:
  ...
  // Constructor.
  Sigma2ffbar2gmZgmZ() : gmZmode(), i1(), i2(), i3(), i4(), i5(), i6(), mRes(), GammaRes(), m2Res(), GamMRat(), thetaWRat(), sigma0(), gamSum3(), intSum3(), resSum3(), gamProp3(), intProp3(), resProp3(), gamSum4(), intSum4(), resSum4(), gamProp4(), intProp4(), resProp4(), c3LL(), c3LR(), c3RL(), c3RR(), c4LL(), c4LR(), c4RL(), c4RR(), flavWt(), particlePtr() {}
...
public:
  ...
  // Constructor.
  Sigma2ffbar2ZW() : mW(), widW(), mWS(), mwWS(), sin2thetaW(), cos2thetaW(), thetaWRat(), cotT(), thetaWpt(), thetaWmm(), lun(), lde(), sigma0(), openFracPos(), openFracNeg() {}
...
public:
  ...
  // Constructor.
  Sigma2ffbar2WW() : mZ(), widZ(), mZS(), mwZS(), thetaWRat(), sigma0(), cgg(), cgZ(), cZZ(), cfg(), cfZ(), cff(), gSS(), gTT(), gST(), gUU(), gSU(), openFracPair() {}
...
public:
  ...
  // Constructor.
  Sigma2ffbargmZggm() : gmZmode(), mRes(), GammaRes(), m2Res(), GamMRat(), thetaWRat(), gamSum(), intSum(), resSum(), gamProp(), intProp(), resProp(), particlePtr() {}
...
public:
  ...
  // Constructor.
  Sigma2gmgm2ffbar(int idIn, int codeIn) : idNew(idIn), codeSave(codeIn), idMass(), idNow(), ef4(), s34Avg(), sigTU(), sigma(), openFracPair() {}
...
public:
  ...
  Sigma2ggm2qqbar(int idIn, int codeIn, string inFluxIn = "ggm")
    : idNew(idIn), codeSave(codeIn), idMass(), idNow(), inFluxSave(inFluxIn), ef2(), s34Avg(), sigTU(), sigma(), openFracPair() {}
