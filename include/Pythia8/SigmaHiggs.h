...
public:
  ...
  // Constructor.
  Sigma1ffbar2H(int higgsTypeIn) : HResPtr(), mRes(), GammaRes(), m2Res(), GamMRat(), sigBW(), widthOut(), higgsType(higgsTypeIn), codeSave(), idRes() {}
...
public:
  ...
  // Constructor.
  Sigma1gg2H(int higgsTypeIn) : HResPtr(), mRes(), GammaRes(), m2Res(), GamMRat(), sigma(), higgsType(higgsTypeIn), codeSave(), idRes() {}
...
public:
  ...
  // Constructor.
  Sigma1gmgm2H(int higgsTypeIn) : HResPtr(), mRes(), GammaRes(), m2Res(), GamMRat(), sigma(), higgsType(higgsTypeIn), codeSave(), idRes() {}
...
public:
  ...
  // Constructor.
  Sigma2ffbar2HZ(int higgsTypeIn) : mZ(), widZ(), mZS(), mwZS(), thetaWRat(), sigma0(), openFracPair(), coup2Z(), higgsType(higgsTypeIn), codeSave(), idRes() {}
...
public:
  ...
  // Constructor.
  Sigma2ffbar2HW(int higgsTypeIn) : mW(), widW(), mWS(), mwWS(), thetaWRat(), sigma0(), openFracPairPos(), openFracPairNeg(), coup2W(), higgsType(higgsTypeIn), codeSave(), idRes() {}
...
public:
  ...
  // Constructor.
  Sigma3ff2HfftZZ(int higgsTypeIn) : mZS(), prefac(), sigma1(), sigma2(), openFrac(), coup2Z(), higgsType(higgsTypeIn), codeSave(), idRes() {}
...
public:
  ...
  // Constructor.
  Sigma3ff2HfftWW(int higgsTypeIn) : mWS(), prefac(), sigma0(), openFrac(), coup2W(), higgsType(higgsTypeIn), codeSave(), idRes() {}
...
public:
  ...
  // Constructor.
  Sigma3gg2HQQbar(int idIn, int higgsTypeIn) : prefac(), sigma(), openFracTriplet(), coup2Q(), idNew(idIn),
...
public:
  ...
  // Constructor.
  Sigma3qqbar2HQQbar(int idIn, int higgsTypeIn) : prefac(), sigma(), openFracTriplet(), coup2Q(), idNew(idIn),
    higgsType(higgsTypeIn), codeSave(), idRes() {}
...
public:
  ...
  // Constructor.
  Sigma2qg2Hq(int idIn, int higgsTypeIn) : m2W(), thetaWRat(), sigma(), openFrac(), idNew(idIn),
    higgsType(higgsTypeIn), codeSave(), idRes() {}
...
public:
  ...
  // Constructor.
  Sigma2gg2Hglt(int higgsTypeIn) : widHgg(), sigma(), openFrac(), higgsType(higgsTypeIn), codeSave(), idRes() {}
...
public:
  ...
  // Constructor.
  Sigma2qg2Hqlt(int higgsTypeIn) : widHgg(), sigma(), openFrac(), higgsType(higgsTypeIn), codeSave(), idRes() {}
...
public:
  ...
  // Constructor.
  Sigma2qqbar2Hglt(int higgsTypeIn) : widHgg(), sigma(), openFrac(), higgsType(higgsTypeIn), codeSave(), idRes() {}
...
public:
  ...
  // Constructor.
  Sigma1ffbar2Hchg() : HResPtr(), mRes(), GammaRes(), m2Res(), GamMRat(), m2W(), thetaWRat(), tan2Beta(), sigBW(), widthOutPos(), widthOutNeg() {}
...
public:
  ...
  Sigma2qg2Hchgq(int idIn, int codeIn, string nameIn) : idNew(idIn),
    codeSave(codeIn), idOld(), idUp(), idDn(), nameSave(nameIn), m2W(), thetaWRat(), tan2Beta(), sigma(), openFracPos(), openFracNeg() {}
...
public:
  ...
  // Constructor.
  Sigma2ffbar2A3H12(int higgsTypeIn) : higgsType(higgsTypeIn), higgs12(), codeSave(), coupZA3H12(), m2Z(), mGammaZ(), thetaWRat(), openFrac(), sigma0() {}
...
public:
  ...
  // Constructor.
  Sigma2ffbar2HchgH12(int higgsTypeIn) : higgsType(higgsTypeIn), higgs12(), codeSave(), coupWHchgH12(), m2W(), mGammaW(), thetaWRat(), openFracPos(), openFracNeg(), sigma0() {}
...
public:
  ...
  // Constructor.
  Sigma2ffbar2HposHneg() : m2Z(), mGammaZ(), thetaWRat(), eH(), lH(), openFrac(), gamSig(), intSig(), resSig() {}
