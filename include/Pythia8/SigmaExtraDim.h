...
public:
  ...
  // Constructor.
  Sigma1gg2GravitonStar() : eDsmbulk(), eDvlvl(), idGstar(), mRes(), GammaRes(), m2Res(), GamMRat(), kappaMG(), sigma(), eDcoupling(), gStarPtr() {}
...
public:
  ...
  // Constructor.
  Sigma1ffbar2GravitonStar() : eDsmbulk(), eDvlvl(), idGstar(), mRes(), GammaRes(), m2Res(), GamMRat(), kappaMG(), sigma0(), eDcoupling(), gStarPtr() {}
...
public:
  ...
  // Constructor.
  Sigma1qqbar2KKgluonStar() : idKKgluon(), mRes(), GammaRes(), m2Res(), GamMRat(), sumSM(), sumInt(), sumKK(), sigSM(), sigInt(), sigKK(), eDgv(), eDga(), interfMode(), gStarPtr() {}
...
public:
  ...
  // Constructor.
  Sigma2gg2GravitonStarg() : idGstar(), mRes(), GammaRes(), m2Res(), GamMRat(), kappaMG(), openFrac(), sigma() {}
...
public:
  ...
  // Constructor.
  Sigma2qg2GravitonStarq() : idGstar(), mRes(), GammaRes(), m2Res(), GamMRat(), kappaMG(), openFrac(), sigma() {}
...
public:
  ...
  // Constructor.
  Sigma2qqbar2GravitonStarg() : idGstar(), mRes(), GammaRes(), m2Res(), GamMRat(), kappaMG(), openFrac(), sigma() {}
...
public:
  ...
  // Constructor.
  Sigma2ffbar2TEVffbar(int idIn, int codeIn) : idNew(idIn), gmZmode(), codeSave(codeIn), nexcitationmax(), isPhysical(), gPlusf(), gMinusf(), gPlusF(), gMinusF(), gPlusTop(), gMinusTop(), gf(), gF(), mRes(), m2Res(), mStar(), mTop(), m2Top(), mZKKn(), m2ZKKn(), m2gmKKn(), mgmKKn(), alphaemfixed(), helicityME2(), coefTot(), coefAngular(), mr(), betaf(), cosThe(), openFracPair(), wgmKKFactor(), wgmKKn(), wZKKn(), wZ0(), ttbarwZKKn(), ttbarwgmKKn(), ttbarwFactorA(), ttbarwFactorB(), phaseSpacemHatMin(), phaseSpacemHatMax() {}
...
public:
  ...
  Sigma2gg2LEDUnparticleg( bool Graviton ) : eDgraviton(Graviton), eDspin(), eDnGrav(), eDidG(), eDcutoff(), mG(), mGS(), eDsigma0(), eDdU(), eDLambdaU(), eDlambda(), eDconstantTerm(), eDtff(), eDcf() {}
...
public:
  ...
  // Constructor: bool Graviton  = true, to use LED graviton settings.
  Sigma2qg2LEDUnparticleq( bool Graviton) : eDgraviton(Graviton), eDspin(), eDnGrav(), eDidG(), eDcutoff(), mG(), mGS(), eDsigma0(), eDdU(), eDLambdaU(), eDlambda(), eDconstantTerm(), eDtff(), eDgf(), eDcf() {}
...
public:
  ...
  // Constructor: bool Graviton  = true, to use LED graviton settings.
  Sigma2qqbar2LEDUnparticleg( bool Graviton) : eDgraviton(Graviton), eDspin(), eDnGrav(), eDidG(), eDcutoff(), mG(), mGS(), eDsigma0(), eDdU(), eDLambdaU(), eDlambda(), eDconstantTerm(), eDtff(), eDgf(), eDcf() {}
...
public:
  ...
  // Constructor: bool Graviton  = true, to use LED graviton settings.
  Sigma2ffbar2LEDUnparticleZ( bool Graviton) : eDspin(), eDnGrav(), eDcutoff(), eDidG(), eDgraviton(Graviton), eDdU(), eDLambdaU(), eDlambda(), eDratio(), eDlambdaPrime(), eDtff(), eDconstantTerm(), sHS(), tHS(), uHS(), tHC(), uHC(), tHQ(), uHQ(), tHuH(), mU(), mUS(), mZ(), widZ(), mZS(), mwZS(), eDsigma0(), openFrac() {}
...
public:
  ...
  // Constructor: bool Graviton  = true, to use LED graviton settings.
  Sigma2ffbar2LEDUnparticlegamma( bool Graviton) : eDspin(), eDnGrav(), eDcutoff(), eDidG(), eDgraviton(Graviton), eDdU(), eDLambdaU(), eDlambda(), eDratio(), eDlambdaPrime(), eDtff(), eDconstantTerm(), sHS(), tHS(), uHS(), tHC(), uHC(), tHQ(), uHQ(), tHuH(), mU(), mUS(), mZ(), mZS(), eDsigma0() {}
...
public:
  ...
  // Constructor: bool Graviton  = true, to use LED graviton settings.
  Sigma2ffbar2LEDgammagamma( bool Graviton) : eDspin(), eDcutoff(), eDnGrav(), eDnegInt(), eDgraviton(Graviton), eDdU(), eDLambdaU(), eDlambda(), eDlambda2chi(), eDterm1(), eDterm2(), eDterm3(), eDtff() {}
...
public:
  ...
  // Constructor: bool Graviton  = true, to use LED graviton settings.
  Sigma2gg2LEDgammagamma( bool Graviton) : eDspin(), eDcutoff(), eDnGrav(), eDgraviton(Graviton), eDdU(), eDLambdaU(), eDlambda(), eDlambda2chi(), eDsigma0(), eDtff() {}
...
public:
  ...
  // Constructor: bool Graviton  = true, to use LED graviton settings.
  Sigma2ffbar2LEDllbar( bool Graviton) : eDspin(), eDcutoff(), eDnGrav(), eDnxx(), eDnxy(), eDnegInt(), eDgraviton(Graviton), eDdU(), eDLambdaU(), eDlambda(), eDlambda2chi(), eDtff(), eDmZ(), eDmZS(), eDGZ(), eDGZS(), eDabsMeU(), eDdenomPropZ(), eDrePropGamma(), eDrePropZ(), eDimPropZ(), eDabsAS(), eDreA(), eDreABW(), eDpoly1(), eDpoly2(), eDpoly3() {}
...
public:
  ...
  // Constructor: bool Graviton  = true, to use LED graviton settings.
  Sigma2gg2LEDllbar( bool Graviton) : eDspin(), eDcutoff(), eDnGrav(), eDgraviton(Graviton), eDdU(), eDLambdaU(), eDlambda(), eDlambda2chi(), eDsigma0(), eDtff() {}
...
public:
  ...
  // Constructor.
  Sigma2gg2LEDgg() : sigTS(), sigUS(), sigTU(), sigSum(), sigma(), eDopMode(), eDnGrav(), eDcutoff(), eDnegInt(), eDMD(), eDLambdaT(), eDtff() {}
...
public:
  ...
  // Constructor.
  Sigma2gg2LEDqqbar() : nQuarkNew(), idNew(), mNew(), m2New(), sigTS(), sigUS(), sigSum(), sigma(), eDopMode(), eDnGrav(), eDcutoff(), eDnegInt(), eDMD(), eDLambdaT(), eDtff() {}
...
public:
  ...
  // Constructor.
  Sigma2qg2LEDqg() : sigTS(), sigTU(), sigSum(), sigma(), eDopMode(), eDnGrav(), eDcutoff(), eDnegInt(), eDMD(), eDLambdaT(), eDtff() {}
...
public:
  ...
  // Constructor.
  Sigma2qq2LEDqq() : sigT(), sigU(), sigTU(), sigST(), sigSum(), sigGrT1(), sigGrT2(), sigGrU(), sigGrTU(), sigGrST(), eDopMode(), eDnGrav(), eDcutoff(), eDnegInt(), eDMD(), eDLambdaT(), eDtff() {}
...
public:
  ...
  // Constructor.
  Sigma2qqbar2LEDgg() : sigTS(), sigUS(), sigSum(), sigma(), eDopMode(), eDnGrav(), eDcutoff(), eDnegInt(), eDMD(), eDLambdaT(), eDtff() {}
...
public:
  ...
  // Constructor.
  Sigma2qqbar2LEDqqbarNew() : nQuarkNew(), idNew(), mNew(), m2New(), sigS(), sigma(), eDopMode(), eDnGrav(), eDcutoff(), eDMD(), eDLambdaT(), eDtff() {}
