...
public:
  ...
  // Constructor.
  StringFlav() : rndmPtr(), particleDataPtr(), infoPtr(), suppressLeadingB(), mT2suppression(), useWidthPre(), probQQtoQ(), probStoUD(), probSQtoQQ(), probQQ1toQQ0(), probQandQQ(), probQandS(), probQandSinQQ(), probQQ1corr(), probQQ1corrInv(), probQQ1norm(), probQQ1join(), mesonRate(), mesonRateSum(), mesonMix1(), mesonMix2(), etaSup(), etaPrimeSup(), decupletSup(), baryonCGSum(), baryonCGMax(), popcornRate(), popcornSpair(), popcornSmeson(), scbBM(), popFrac(), popS(), dWT(), lightLeadingBSup(), heavyLeadingBSup(), sigmaHad(), widthPreStrange(), widthPreDiquark(), thermalModel(), mesonNonetL1(), temperature(), tempPreFactor(), nNewQuark(), mesMixRate1(), mesMixRate2(), mesMixRate3(), baryonOctWeight(), baryonDecWeight(), closePacking(), exponentMPI(), exponentNSP() {
...
public:
  ...
  // Constructor.
  StringZ() : useNonStandC(), useNonStandB(), useNonStandH(), usePetersonC(), usePetersonB(), usePetersonH(), mc2(), mb2(), aLund(), bLund(), aExtraSQuark(), aExtraDiquark(), rFactC(), rFactB(), rFactH(), aNonC(), aNonB(), aNonH(), bNonC(), bNonB(), bNonH(), epsilonC(), epsilonB(), epsilonH(), stopM(), stopNF(), stopS(), rndmPtr() {}
...
public:
  ...
  // Constructor.
  StringPT() : useWidthPre(), sigmaQ(), enhancedFraction(), enhancedWidth(), sigma2Had(), widthPreStrange(), widthPreDiquark(), thermalModel(), temperature(), tempPreFactor(), fracSmallX(), closePacking(), exponentMPI(), exponentNSP(), particleDataPtr(), rndmPtr(), infoPtr() {}
