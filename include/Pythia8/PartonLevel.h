...
public:
  ...
  // Constructor.
  PartonLevel() : timesDecPtr(), timesPtr(), spacePtr(), userHooksPtr(0), doNonDiff(), doDiffraction(), doMPI(), doMPIMB(), doMPISDA(), doMPISDB(), doMPICD(), doMPIinit(), doISR(), doFSRduringProcess(), doFSRafterProcess(), doFSRinResonances(), doRemnants(), doSecondHard(), hasOneLeptonBeam(), hasTwoLeptonBeams(), hasPointLeptons(), canVetoPT(), canVetoStep(), canVetoMPIStep(), canVetoEarly(), canSetScale(), allowRH(), earlyResDec(), vetoWeakJets(), canReconResSys(), doReconnect(), doHardDiff(), forceResonanceCR(), doNDgamma(), doMPIgmgm(), showUnresGamma(), pTmaxMatchMPI(), mMinDiff(), mWidthDiff(), pMaxDiff(), vetoWeakDeltaR2(), doVeto(), nMPI(), nISR(), nFSRinProc(), nFSRinRes(), nISRhard(), nFSRhard(), typeLatest(), nVetoStep(), typeVetoStep(), nVetoMPIStep(), iSysNow(), reconnectMode(), sampleTypeDiff(), pTsaveMPI(), pTsaveISR(), pTsaveFSR(), pTvetoPT(), isNonDiff(), isDiffA(), isDiffB(), isDiffC(), isDiff(), isSingleDiff(), isDoubleDiff(), isCentralDiff(), isResolved(), isResolvedA(), isResolvedB(), isResolvedC(), isHardDiffA(), isHardDiffB(), isHardDiff(), doDiffVeto(), sizeProcess(), sizeEvent(), nHardDone(), nHardDoneRHad(), iDS(), eCMsave(), hasGammaA(), hasGammaB(), beamHasGamma(), beamAhasResGamma(), beamBhasResGamma(), beamHasResGamma(), isGammaHadronDir(), gammaMode(), gammaModeEvent(), infoPtr(), particleDataPtr(), rndmPtr(), beamAPtr(), beamBPtr(), beamHadAPtr(), beamHadBPtr(), beamPomAPtr(), beamPomBPtr(), beamGamAPtr(), beamGamBPtr(), couplingsPtr(), partonSystemsPtr(), partonVertexPtr(), multiPtr(), rHadronsPtr(), mergingHooksPtr(), doTrial(), nTrialEmissions(), pTLastBranch(), typeLastBranch(), canRemoveEvent(), canRemoveEmission() {}
