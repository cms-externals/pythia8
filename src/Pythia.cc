...
Pythia::Pythia(string xmlDir, bool printBanner) : couplingsPtr(), mergingPtr(), mergingHooksPtr(), doProcessLevel(), doPartonLevel(), doHadronLevel(), doDiffraction(), doHardDiff(), doResDec(), doFSRinRes(), decayRHadrons(), abortIfVeto(), checkEvent(), checkHistory(), nErrList(), epTolErr(), epTolWarn(), mTolErr(), mTolWarn(), beamHasGamma(), beamAisResGamma(), beamBisResGamma(), beamAhasResGamma(), beamBhasResGamma(), gammaMode(), isUnresolvedA(), isUnresolvedB(), showSaV(), showMaD(), doReconnect(), forceHadronLevelCR(), idA(), idB(), frameType(), boostType(), nCount(), nShowLHA(), nShowInfo(), nShowProc(), nShowEvt(), reconnectMode(), mA(), mB(), pxA(), pxB(), pyA(), pyB(), pzA(), pzB(), eA(), eB(), pzAcm(), pzBcm(), eCM(), betaZ(), gammaZ(), nErrEvent(), pdfAPtr(), pdfBPtr(), pdfHardAPtr(), pdfHardBPtr(), pdfPomAPtr(), pdfPomBPtr(), pdfGamAPtr(), pdfGamBPtr(), pdfHardGamAPtr(), pdfHardGamBPtr(), pdfUnresAPtr(), pdfUnresBPtr(), pdfUnresGamAPtr(), pdfUnresGamBPtr(), useNewPdfA(), useNewPdfB(), useNewPdfHard(), useNewPdfPomA(), useNewPdfPomB(), useNewPdfGamA(), useNewPdfGamB(), useNewPdfHardGamA(), useNewPdfHardGamB(), useNewPdfUnresA(), useNewPdfUnresB(), useNewPdfUnresGamA(), useNewPdfUnresGamB(), hasUserHooksVector(), doLHA(), useNewLHA(), lhaUpPtr(), decayHandlePtr(), userHooksPtr(), hasUserHooks(), doVetoProcess(), doVetoPartons(), retryPartonLevel(), beamShapePtr(), useNewBeamShape(), doMomentumSpread(), doVertexSpread(), timesDecPtr(), timesPtr(), spacePtr(), useNewTimesDec(), useNewTimes(), useNewSpace(), hasMerging(), hasOwnMerging(), hasMergingHooks(), hasOwnMergingHooks(), doMerging() {
